...
class SQLTest {
    ...
    void newDatabase() {
        ...
        Database db = SQL.newDatabase("Ente",new Connector.DatabaseKey(Connector.DatabaseType.MySQL,"localhost",3306,"jsql",System.getenv("dbUser"),System.getenv("dbPasswd")),10, e -> Logger.error("Connection",e));
        try {
            db.initiate();
